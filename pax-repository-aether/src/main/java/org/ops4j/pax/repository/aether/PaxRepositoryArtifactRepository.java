 ...
 *
 */
public class PaxRepositoryArtifactRepository implements ArtifactRepository
{
    ...
    public PaxRepositoryArtifactRepository()
    {
        this( "ops4j-pax-repository" );
    }

    public PaxRepositoryArtifactRepository( String type )
    {
        this( type, null );
    }

    public PaxRepositoryArtifactRepository( String type, Object key )
    {
    ...
    public boolean equals( Object obj )
    {
        ...
        PaxRepositoryArtifactRepository that = (PaxRepositoryArtifactRepository) obj;
